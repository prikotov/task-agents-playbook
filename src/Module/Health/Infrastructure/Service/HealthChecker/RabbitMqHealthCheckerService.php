...
/**
 * Сервис проверки здоровья RabbitMQ для регистрации в HealthCheckerRegistry.
 */
final readonly class RabbitMqHealthCheckerService implements CheckHealthServiceInterface
{
    private const string SERVICE_NAME = 'rabbitmq';
