...
3. ✅ Пользователь может выполнять semantic search по индексу через API
4. ✅ Basic web-UI позволяет просматривать sources и результаты поиска
5. ✅ Pipeline обрабатывает **минимум 50 документов** без критических ошибок
6. ✅ Search latency для **простых запросов** < 2 секунд
7. ✅ CLI команды работают корректно (ingestion, query, status)
8. ✅ Docker compose поднимает full stack одной командой
9. ✅ Basic error logging работает (настроен monolog)
