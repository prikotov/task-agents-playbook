...
- check_circleData used to improve our products[\*](https://ai.google.dev/gemini-api/terms)
...
- check_circleData \*not\* used to improve our products[\*](https://ai.google.dev/gemini-api/terms)
