...
- При создании нового helper-класса обязательно добавляйте его FQCN в `StaticAccess` exceptions в [`phpmd.xml`](../../../phpmd.xml), иначе PHPMD будет считать его static-вызовы нарушением.
