...
/**
 * @extends AbstractType<EditFormModel>
 */
final class EditFormType extends AbstractType
{
    #[Override]
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('title', TextType::class, [
                ...
                'constraints' => [
                    new NotBlank(message: 'health.incident.form.title.not_blank'),
                ],
            ])
            ...
            ->add('status', EnumType::class, [
                ...
                'required' => true,
                'label' => 'health.incident.form.status.label',
            ])
            ...
            ->add('submit', SubmitType::class, [
                'label' => 'health.incident.form.edit.submit',
            ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => EditFormModel::class,
